...
export const submittalPriorityEnum = z.enum([
...
export const listSubmittalsSchema = z.object({
  ...
  priority: submittalPriorityEnum.optional(),
...
export const createSubmittalSchema = z.object({
  ...
  priority: submittalPriorityEnum.nullable().optional(),
  description: z.string().trim().max(50000).nullable().optional(),
  required_date: dateString.nullable().optional(),
  submission_date: dateString.nullable().optional(),
  submitted_by: z.string().uuid().nullable().optional(),
  submitted_to: z.string().trim().max(255).nullable().optional(),
