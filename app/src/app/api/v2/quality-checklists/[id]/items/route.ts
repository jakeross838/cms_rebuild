...
export const GET = createApiHandler(
  async (req: NextRequest, ctx: ApiContext) => {
    ...
    const { data, count, error } = await supabase
      ...
      .select('id, company_id, checklist_id, description, result, notes, photo_url, sort_order, created_at, updated_at', { count: 'exact' })
...
export const POST = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'superintendent'], auditAction: 'quality_checklists_item.create' }
)
