...
export const GET = createApiHandler(
  async (req: NextRequest, ctx: ApiContext) => {
    ...
    const { data, error } = await supabase
      .from('assemblies')
      .select('id, company_id, name, description, category, parameter_unit, is_active, created_at, updated_at, assembly_items(id)')
      .eq('id', id)
...
export const PUT = createApiHandler(
  async (req: NextRequest, ctx: ApiContext) => {
    ...
    const { data, error } = await supabase
      ...
      .eq('company_id', ctx.companyId!)
      .is('deleted_at', null)
      .select('id, company_id, name, description, category, parameter_unit, is_active, created_at, updated_at')
      .single()
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'office'], auditAction: 'assembly.update' }
)
...
export const DELETE = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'office'], auditAction: 'assembly.archive' }
)
