...
export const PUT = createApiHandler(
  ...
  { requireAuth: true, requiredRoles: ['owner', 'admin'], rateLimit: 'api', auditAction: 'api_key.update' }
)
...
export const DELETE = createApiHandler(
  ...
  { requireAuth: true, requiredRoles: ['owner', 'admin'], rateLimit: 'api', auditAction: 'api_key.revoke' }
)
