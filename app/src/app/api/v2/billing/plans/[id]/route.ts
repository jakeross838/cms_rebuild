...
export const PUT = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'financial', requiredRoles: ['owner'], auditAction: 'billing_plan.update' }
)
...
export const DELETE = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'financial', requiredRoles: ['owner'], auditAction: 'billing_plan.deactivate' }
)
