...
export const PUT = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'financial', requiredRoles: ['owner'], auditAction: 'addon.update' }
)
...
export const DELETE = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'financial', requiredRoles: ['owner'], auditAction: 'addon.delete' }
)
