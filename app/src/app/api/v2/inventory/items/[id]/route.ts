...
export const PUT = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'office'], auditAction: 'inventory_item.update' }
)
...
export const DELETE = createApiHandler(
  async (req: NextRequest, ctx: ApiContext) => {
    ...
    // Verify item exists before archiving
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'office'], auditAction: 'inventory_item.archive' }
)
