...
export const PUT = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'office'], auditAction: 'inventory_location.update' }
)
...
export const DELETE = createApiHandler(
  async (req: NextRequest, ctx: ApiContext) => {
    ...
    // Verify location exists before deactivating
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'office'], auditAction: 'inventory_location.archive' }
)
