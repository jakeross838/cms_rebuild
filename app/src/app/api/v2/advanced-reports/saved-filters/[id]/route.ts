...
export const PUT = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'office'], auditAction: 'advanced_report_saved_filter.update' }
)
...
export const DELETE = createApiHandler(
  async (req: NextRequest, ctx: ApiContext) => {
    ...
    // Verify saved filter exists before archiving
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm', 'office'], auditAction: 'advanced_report_saved_filter.archive' }
)
