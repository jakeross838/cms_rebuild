/**
 * Vendor Contacts API (flat route) — List & Create
 *
 * GET  /api/v2/contacts — List vendor contacts (filtered by company)
 * POST /api/v2/contacts — Create a new vendor contact (vendor_id in body)
 */
...
export const GET = createApiHandler(
  async (req, ctx: ApiContext) => {
    ...
    if (filters.q) {
      query = query.or(`name.ilike.${safeOrIlike(filters.q)},email.ilike.${safeOrIlike(filters.q)}`)
    }
...
// ============================================================================
// POST /api/v2/contacts — Create vendor contact
// ============================================================================
...
export const POST = createApiHandler(
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm'], auditAction: 'vendor_contact.create' }
)
