...
export const GET = createApiHandler(
  async (req, ctx: ApiContext) => {
    ...
    let query = supabase
      ...
      .select('id, company_id, vendor_id, job_id, trade, quality_rating, timeliness_rating, communication_rating, budget_adherence_rating, safety_rating, overall_rating, tasks_on_time, tasks_total, punch_items_count, punch_resolution_avg_days, inspection_pass_rate, bid_amount, final_amount, change_order_count, rating_notes, rated_by, created_at, updated_at', { count: 'exact' })
...
export const POST = createApiHandler(
  async (req, ctx: ApiContext) => {
    ...
    const { data, error } = await supabase
      ...
      .select('id, company_id, vendor_id, job_id, trade, quality_rating, timeliness_rating, communication_rating, budget_adherence_rating, safety_rating, overall_rating, tasks_on_time, tasks_total, punch_items_count, punch_resolution_avg_days, inspection_pass_rate, bid_amount, final_amount, change_order_count, rating_notes, rated_by, created_at, updated_at')
      .single()
  ...
  { requireAuth: true, rateLimit: 'api', requiredRoles: ['owner', 'admin', 'pm'], auditAction: 'vendor_performance_job_rating.create' }
)
