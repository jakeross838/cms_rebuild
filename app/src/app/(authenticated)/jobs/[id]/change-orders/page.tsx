...
export default async function ChangeOrdersPage({
  ...
  if (sp.search) {
    coQuery = coQuery.or(`co_number.ilike.${safeOrIlike(sp.search)},title.ilike.${safeOrIlike(sp.search)}`)
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative max-w-md">
        ...
        <form><Input type="search" name="search" placeholder="Search change orders..." aria-label="Search change orders" defaultValue={sp.search} className="pl-10" /></form>
      </div>
