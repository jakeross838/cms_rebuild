  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative max-w-md">
        ...
        <form><Input type="search" name="search" placeholder="Search purchase orders..." aria-label="Search purchase orders" defaultValue={sp.search} className="pl-10" /></form>
      </div>
      ...
      <ListPagination currentPage={page} totalPages={totalPages} basePath={`/jobs/${id}/purchase-orders`} searchParams={sp as Record<string, string | undefined>} />
    </div>
  )
}
