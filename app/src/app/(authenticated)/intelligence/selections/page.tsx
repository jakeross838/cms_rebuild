  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">AI-powered product selection recommendations</p>
      </div>
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16">
          <Palette className="h-12 w-12 text-muted-foreground/50 mb-4" />
          <p className="text-lg font-medium text-muted-foreground">Selection intelligence coming soon</p>
        </CardContent>
      </Card>
    </div>
  )
