...
export default function NewRfiError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('new RFI form error:', error)
  }, [error])

  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center gap-4 p-8">
      <AlertTriangle className="h-12 w-12 text-amber-500" />
      <h2 className="text-xl font-semibold text-foreground">Failed to load RFI form</h2>
