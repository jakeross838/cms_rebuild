  ...
  return (
    <PageSpec
      ...
      features={[
        ...
        'Widget library from all system data',
        'Chart types: Bar, Line, Pie, Gauge, Table, KPI cards',
        'Real-time data refresh',
        'Date range filters (global and per-widget)',
        'Job filters for scoping data',
        'Custom KPI calculations',
        'Dashboard templates (Executive, PM, Financial)',
