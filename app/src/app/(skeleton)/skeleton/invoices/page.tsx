      ...
      {activeTab === 'preview' ? (
        ...
        <PageSpec
          ...
          features={[
            ...
            'Budget Line allocation with 100% balance requirement (strict enforcement)',
          ...
          connections={[
            ...
            { name: 'Budget Lines', type: 'input', description: 'Allocation of invoice amounts to active budget lines' },
