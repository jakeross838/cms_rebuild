...
export const companyNav: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Proposals', href: '/proposals', description: 'Client presentations' },
      { name: 'Contracts', href: '/contracts', description: 'E-signature, execution' },
      { name: 'Legal & Compliance', href: '/legal', description: 'Contract builder, lien law, subcontracts' },
    ],
  },
  {
    label: 'Pre-Con',
    icon: Compass,
    items: [
      { name: 'Feasibility', href: '/pre-construction', description: 'Lot analysis, zoning, site due diligence' },
    ],
  },
  {
    label: 'Jobs',
...
export const companyJobNav: NavItem[] = [
  {
    ...
    icon: Calendar,
    items: [
      { name: 'Calendar', href: '/operations/calendar', description: 'Company-wide schedule' },
      { name: 'Crew Schedule', href: '/operations/crew-schedule', description: 'Resource allocation' },
      ...
      { name: 'Deliveries', href: '/operations/deliveries', description: 'Incoming materials' },
    ],
  },
  {
    label: 'Financial',
    ...
    items: [
      ...
      { name: 'Bank Reconciliation', href: '/financial/bank-reconciliation', description: 'Bank account matching' },
      { name: 'Cash Flow', href: '/financial/cash-flow', description: 'Forecasting' },
      { name: 'Profitability', href: '/financial/profitability', description: 'Margin analysis' },
      { name: 'Reports', href: '/financial/reports', description: 'Financial reports' },
      { name: 'Business Mgmt', href: '/financial/business-management', description: 'Company P&L, overhead, capacity' },
      { name: 'Job Close', href: '/financial/job-close', description: 'Final reconciliation & CPA export' },
    ],
  },
  {
    label: 'Closeout',
    ...
    items: [
      ...
      { name: 'Post-Build', href: '/post-build', description: 'Warranty walkthroughs, maintenance, referrals' },
    ],
  },
]
...
export const companyRightNav: NavItem[] = [
  {
    ...
    items: [
      ...
      { name: 'Contacts', href: '/contacts', description: 'Other contacts' },
      { name: 'HR & Workforce', href: '/hr', description: 'Org chart, hiring, training, reviews' },
    ],
  },
  {
    label: 'Library',
    icon: Database,
    items: [
      { name: 'Selections Catalog', href: '/library/selections', description: 'Products & materials' },
      { name: 'Assemblies', href: '/library/assemblies', description: 'Estimate templates' },
      { name: 'Cost Codes', href: '/cost-codes', description: 'Budget categories' },
      { name: 'Templates', href: '/library/templates', description: 'Standard forms' },
    ],
  },
  {
    label: 'Settings',
    ...
    items: [
      ...
      { name: 'Integrations', href: '/integrations', description: 'QuickBooks, Stripe' },
      { name: 'Insurance', href: '/compliance/insurance', description: 'COIs & policies' },
      { name: 'Licenses', href: '/compliance/licenses', description: 'Contractor licenses' },
      { name: 'Safety', href: '/compliance/safety', description: 'OSHA & incidents' },
      { name: 'Lien Law', href: '/compliance/lien-law', description: 'State-specific lien deadlines & notices' },
      { name: 'Dashboards', href: '/dashboards', description: 'Custom views' },
      { name: 'Email Marketing', href: '/email-marketing', description: 'Client outreach' },
    ],
  },
]
