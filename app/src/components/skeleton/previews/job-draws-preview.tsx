      ...
      >
        <td className="py-3 px-4">
          <div className="flex items-center gap-2">
            ...
            {draw.autoGenerated && <span className="text-xs bg-warm-50 text-stone-600 px-1.5 py-0.5 rounded">Auto</span>}
            ...
            {draw.dailyLogsCount && draw.dailyLogsCount > 0 && (
              <span className="text-xs bg-stone-50 text-stone-600 px-1.5 py-0.5 rounded flex items-center gap-1">
