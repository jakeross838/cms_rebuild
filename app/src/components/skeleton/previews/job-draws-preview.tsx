                ...
                <td className="py-1.5 px-2 text-center">
                  {item.verified ? (
                    <span className="inline-flex items-center gap-1 text-green-600">
                      ...
                      {item.verificationDate ? <span className="text-warm-400">{item.verificationDate}</span> : null}
                    </span>
                  ) : (
      ...
      >
        <td className="py-3 px-4">
          <div className="flex items-center gap-2">
            ...
            {draw.dailyLogsCount && draw.dailyLogsCount > 0 ? <span className="text-xs bg-stone-50 text-stone-600 px-1.5 py-0.5 rounded flex items-center gap-1">
          ...
          <td colSpan={7} className="py-3 px-12">
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-4 gap-4 text-sm">
                ...
                {draw.dailyLogsCount && draw.dailyLogsCount > 0 ? <div className="flex items-center gap-1">
                    <BookOpen className="h-3.5 w-3.5 text-stone-600" />
                    <span className="text-stone-700 font-medium">Supported by {draw.dailyLogsCount} daily log entries</span>
                  </div> : null}
              ...
              {/* Stored Materials Breakdown */}
              {draw.storedMaterialItems && draw.storedMaterialItems.length > 0 ? <StoredMaterialsBreakdown items={draw.storedMaterialItems} /> : null}

              {/* SOV Line Preview for expanded draws */}
              {draw.sovLines && draw.sovLines.length > 0 ? <div className="mt-2">
              ...
              {draw.aiNote ? <div className="flex items-start gap-2 text-sm text-amber-700 bg-amber-50 rounded-lg p-2 border border-amber-200">
          ...
          <div>
            ...
            <div className="text-sm text-warm-500 mt-0.5 flex items-center gap-4">
              <span className="flex items-center gap-1">
                ...
                {netChangeOrders > 0 && (
                  <span className="text-xs bg-sand-50 text-sand-600 px-1.5 py-0.5 rounded ml-1">
      ...
      <div className="bg-white border-b border-warm-200 px-4 py-3">
        <div className="flex items-center gap-6 text-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div><span className="text-warm-500">COs:</span> <span className="font-medium text-sand-600">+{formatCurrency(netChangeOrders)}</span></div>
