...
function InfoCard({
  ...
  return (
    <div className={cn("bg-white rounded-lg border border-warm-200 overflow-hidden", className)}>
      <div className="px-4 py-2.5 bg-warm-50 border-b border-warm-200 flex items-center gap-2">
...
function FeatureBadge({ feature }: { feature: string }) {
  ...
  return (
    <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-stone-50 rounded-lg text-stone-700 text-sm">
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h3 className="font-semibold text-warm-900">Property Details - {p.jobName}</h3>
            ...
            <div className="flex items-center gap-4 text-sm text-warm-500 mt-1">
              ...
              <span className="text-xs text-warm-400">{p.county} County</span>
            </div>
      ...
      <div className="p-4">
        ...
        <div className="mt-4 grid grid-cols-4 gap-4">
          <div className="bg-white rounded-lg border border-warm-200 p-3 flex items-center gap-3">
            <Droplets className="h-5 w-5 text-stone-500" />
            <div>
              <div className="text-xs text-warm-500">Water</div>
              <div className="text-sm font-medium text-warm-900">{p.waterSource}</div>
            </div>
          </div>
          <div className="bg-white rounded-lg border border-warm-200 p-3 flex items-center gap-3">
            <Mountain className="h-5 w-5 text-warm-500" />
            <div>
              <div className="text-xs text-warm-500">Sewer</div>
              <div className="text-sm font-medium text-warm-900">{p.sewerType}</div>
            </div>
          </div>
          <div className="bg-white rounded-lg border border-warm-200 p-3 flex items-center gap-3">
          ...
          <div className="bg-white rounded-lg border border-warm-200 p-3 flex items-center gap-3">
            ...
            <div>
              <div className="text-xs text-warm-500">Electric</div>
              <div className="text-sm font-medium text-warm-900">{p.electricProvider}</div>
            </div>
          </div>
        </div>

        {/* Special Features */}
        <div className="mt-4 bg-white rounded-lg border border-warm-200 p-4">
          <div className="flex items-center gap-2 mb-3">
            <FileText className="h-4 w-4 text-warm-500" />
            <h4 className="font-medium text-warm-900 text-sm">Special Features</h4>
          </div>
        ...
        <div className="mt-4 bg-white rounded-lg border border-warm-200 p-4">
          <div className="flex items-center gap-2 mb-3">
            <Layers className="h-4 w-4 text-warm-500" />
            <h4 className="font-medium text-warm-900 text-sm">Connected Modules</h4>
          </div>
          <div className="grid grid-cols-4 gap-3 text-sm">
            <div className="flex items-center gap-2 text-warm-600">
              <span className="text-xs bg-stone-50 text-stone-600 px-1.5 py-0.5 rounded">Estimating</span>
              <span className="text-xs text-warm-400">$/SF, quantities</span>
            </div>
            <div className="flex items-center gap-2 text-warm-600">
              <span className="text-xs bg-green-50 text-green-600 px-1.5 py-0.5 rounded">Budget</span>
              <span className="text-xs text-warm-400">Cost drivers</span>
            </div>
            <div className="flex items-center gap-2 text-warm-600">
              <span className="text-xs bg-amber-50 text-amber-600 px-1.5 py-0.5 rounded">Schedule</span>
              <span className="text-xs text-warm-400">Duration factors</span>
            </div>
            <div className="flex items-center gap-2 text-warm-600">
            ...
            <div className="flex items-center gap-2 text-warm-600">
              <span className="text-xs bg-warm-100 text-warm-600 px-1.5 py-0.5 rounded">Reports</span>
              <span className="text-xs text-warm-400">Job cost data</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 text-sm text-amber-700">
            ...
            <p>
              ...
              <span className="ml-2 text-xs bg-stone-100 text-stone-700 px-1.5 py-0.5 rounded">{aiFieldCount} fields extracted from plans (Dec 20)</span>
            </p>
          </div>
        </div>
      </div>
