...
export function EditUserModal({ userId, onClose, onSuccess }: EditUserModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true" aria-labelledby="edit-user-modal-title">
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-black/50"
        onClick={onClose}
      ...
      <div className="relative bg-background rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-lg font-semibold text-foreground flex items-center gap-2">
            ...
            <span id="edit-user-modal-title">Edit User</span>
          </h2>
          <button
            onClick={onClose}
            aria-label="Close"
